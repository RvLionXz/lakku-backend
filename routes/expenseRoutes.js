...
router.get('/user/:id_user/all', expenseController.getExpensesByUser);

router.get('/user/:id_user/monthly', expenseController.getCurrentMonthExpensesByUser);
...
// Route untuk mendapatkan pengeluaran bulanan 
